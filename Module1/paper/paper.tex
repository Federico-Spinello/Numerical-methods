...
Il metodo bootstrap è risultato ottimale, con $\chi^2_{\text{red}}$ vicini ai valori ideali ($\sim 0.4-0.14$) e stime di $T_c$ in perfetto accordo con il valore teorico.
