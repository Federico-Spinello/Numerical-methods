...
\begin{figure}[H]
    ...
    \includegraphics[width=\columnwidth]{../plots/thermalization_zoom_good.png}
...
È stato anche testata la condizione iniziale "hot", dove, inizialmente, ogni particella aveva spin random. Quello che è stato osservato è che, come atteso, la termalizzazione richiedeva molto più tempo rispetto alla partenza "cold". Nonostante questo, la termalizzazione veniva comunque raggiunta entro i 10000 cluster updates, come è visibile nel grafico \ref{}
\begin{figure}[H]
    \centering
